...
def index12():
    ...
    if areaName == 'Scotland':
        # temp = pd.read_csv('history_data_scotland_temperature.csv')
        filename = 'knn-model-scotland-daily.pkl'

    if areaName == 'Northern Ireland':
        # temp = pd.read_csv('history_data_northern_ireland_temperature.csv')
        filename = 'knn-model-northern-ireland-daily.pkl'

    if areaName == 'Wales':
        # temp = pd.read_csv('history_data_wales_temperature.csv')
    ...
    #
    # Keep wanted columns
    # columns = ['areaName', 'date', 'newCasesBySpecimenDate', 'cumCasesBySpecimenDate']
    # specimen = specimen[columns]
    #
