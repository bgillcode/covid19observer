...
export default class LineChart extends Component {
  ...
  //     for (var i = 0; i < this.state.dataGottenBack[0].length; i++) {
  //       var gottenCumulativeAdmissions = 0;
  //       console.log(this.state.dataGottenBack[0].data[i].cumAdmissions);
  //       if (this.state.dataGottenBack[0].data[i].cumAdmissions !== null) {
  //         gottenCumulativeAdmissions = this.state.dataGottenBack[0].data[4].cumAdmissions;
  //         console.log(gottenCumulativeAdmissions);
  //         return gottenCumulativeAdmissions;
  //       }
  //     }
  // }
  ...
  getAndDisplayCOVIDInformation() {
    ...
    if (this.state.dataGottenBack[0]) {
      ...
      // // console.log(this.state.dataGottenBack[0].data[4].cumAdmissions);
      // for (var i = 0; i < this.state.dataGottenBack[0].length; i++) {
      //   console.log(this.state.dataGottenBack[0].data[i].cumAdmissions);
      //   if (this.state.dataGottenBack[0].data[i].cumAdmissions !== null) {
      //     // gottenCumulativeAdmissions = this.state.dataGottenBack[0].data[4].cumAdmissions;
      ...
      //   }
      // }
      // console.log(this.state.dataGottenBack[0].data[0].areaType);
      if (this.state.dataGottenBack[0]) {
    ...
    //   console.log(this.state.dataGottenBack[0].data);
    //
    // }
